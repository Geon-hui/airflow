from operators.seoul_api_to_csv_operator import SeoulApiToCsvOperator # plugins 폴더 작성 x
import pendulum
...
with DAG(
    ...
    tb_corona19_count_status = SeoulApiToCsvOperator(
        ...
        path='/opt/airflow/files/TbCorona19CountStatus/{{data_interval_end.in_timezone("Asia/Seoul") | ds_nodash }}', # TASK 실행 주체 = WORKER, WORKER_CONTAINER의 경로
